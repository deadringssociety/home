...
**Continuing with the proof:** Checking $\varphi(n) = n \cdot 1_F$
...
$$(m \cdot 1_F)(n \cdot 1_F) \quad (\text{since } 1_F \cdot 1_F = 1_F) = \varphi(m)\varphi(n)$$

⋆ $\varphi(1) = 1 \cdot 1_F = 1_F$

$\square$

> **Every field $F$ of characteristic 0 has a copy of $\mathbb{Q}$** — i.e., has a subfield isomorphic to $\mathbb{Q}$
